...
export default function Navigation() {
  return (
    <nav className="from-primaryBg to-secondaryBg top-0 z-0 flex h-14 w-full snap-start items-center justify-center bg-gradient-to-r box-decoration-clone p-4 align-middle">
