  ...
  return (
    <section className="flex flex-1 grid-flow-col grid-cols-12 sm:grid">
      ...
      <div className="bg-primaryBg col-span-8 p-2 ">
        ...
        <ul>
          <li>
            Some say I am sick, but I enjoy finding creative solutions to new
          ...
          <li>
            ...
            <ul className="pl-3">
              <li>
                Even so, as a concientious self-starter, I do catch up on my
                daily goals as the day develops.
              </li>
            </ul>
          </li>
          <li>
            One challenge I need to be mindful of is an occasional fall back
            into some perfectist tendencies.
          </li>
          <li>
          ...
          <li>
            Compassionate by nature with Bachelor in Psychology, I have
            developed refined communication skills essential for influencing
            change.
          </li>
          <li>
