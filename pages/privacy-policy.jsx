  ...
  return (
    <PagesLayout>
      <div className="sm:px-32 px-4 py-6 bg-primary text-primary-contrast">
        ...
        <p>JeffreyBarron.com is committed to providing quality services to you and this policy outlines my ongoing obligations to you in respect of how we manage your Personal Information.</p>
        ...
        <h2>Third Parties</h2>
        <p>Where reasonable and practicable to do so, we will collect your Personal Information only from you. However, in some circumstances we may be provided with information by third parties.</p>
        ...
        <p>When your Personal Information is no longer needed for the purpose for which it was obtained, we will take reasonable steps to destroy or permanently de-identify your Personal Information. However, most of the Personal Information is or will be stored in client files which may be kept by us, and disposed at our discretion.</p>
        ...
        <p><span>Jeffrey Barron</span> will not charge any fee for your access request, but may charge an administrative fee for providing a copy of your Personal Information.</p>
        ...
        <p>If you have any queries or complaints about my Privacy Policy please contact via my contact page.</p>
