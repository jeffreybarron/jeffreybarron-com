...
image: /blog/images/postgres-betterthan-mysql.png
...
**Figure 1**
<Image
 src={`/blog/attachments/Pasted image 20220812100426.png`}
 alt={`Screenshot of postgresql.conf`}
 aria-label={`Screenshot of postgresql.conf`}
/>
...
**Figure 2 - Before**
 <Image
 src={`/blog/attachments/Pasted image 20220812100705.png`}
...
**Figure 3 - After**
 <Image
 src={`/blog/attachments/Pasted image 20220812100836.png`}
