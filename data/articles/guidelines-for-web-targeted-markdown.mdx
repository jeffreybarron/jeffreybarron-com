...
- keep filenames simple ^1
  ...
  - __Before you publish check your slug, and keyword SEO__
...
```js
<Image src={`/images/blog-attachments/__IMAGE__`} alt={`__TEXT__`} aria-label={`__TEXT__`} />
```
