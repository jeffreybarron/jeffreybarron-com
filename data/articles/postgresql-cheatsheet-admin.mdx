...
image: /articles/images/postgres-betterthan-mysql.png
...
<Image src={`/articles/attachments/Pasted image 20220812100426.png`} alt={`Screenshot of postgresql.conf`} aria-label={`Screenshot of postgresql.conf`} />
...
{' '}
<Image
  src={`/articles/attachments/Pasted image 20220812100705.png`}
  alt={`Before screenshot of PostgreSQL pg_hba.conf`}
  aria-label={`Before screenshot of PostgreSQL pg_hba.conf`}
/>
...
{' '}
<Image
  src={`/articles/attachments/Pasted image 20220812100836.png`}
  alt={`After screenshot of PostgreSQL pg_hba.conf`}
  aria-label={`After screenshot of PostgreSQL pg_hba.conf`}
/>
