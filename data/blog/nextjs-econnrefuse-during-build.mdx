...
canonicalUrl: "https://jeffreybarron.com/blog/nextjs-econnrefuse-during-build"
summary: "Nextjs documentation is slightly misleading for examples on getStaticPaths, showing the use of fetch from an API. However, the not so obvious gotcha happens if you fetch from your app's own API. While working in `npm run dev` everything works fine, but it all breaks when you build your app. The solution, however, is quite obvious."
tags: ["nextjs","build", "tip"]
layout: "MDXLayout"
images: ["opera_house.jpg", "harbour_bridge.jpg"]
authors: ["jeffbarron"]
dateCreated: "2023-04-07T01:13:21Z+1000"
createdTimeStamp: "1680794001177"
dateModified: "2023-04-07T01:13:21Z+1000"
---

`TL;DR` don't call your own API for getStaticPaths()

[^Attribution] ==I straight up copied this from Stack Overflow because it is so well written and it will be easier for me to find it in the future, if I copy it here.==
