---
dateModified: 2023-04-08T12:03:35Z+1000  
dateCreated: 2023-04-08T12:03:35Z+1000  
layout: MDXLayout  
images: [opera_house.jpg, harbour_bridge.jpg]  
title: Git Cheatsheet  
slug: git_cheatsheet
canonicalUrl: https://jeffreybarron.com/blog/git_cheatsheet  
summary: A Cheatsheet of gists and oneliners for github and gitlab version control software.
authors: [jeffbarron]  
tags: [published, git, cheatsheet]
---
...
**_detached head:_** In rare cases, the HEAD file does NOT contain a branch reference, but an SHA-1 value of a specific revision. This happens when you check out a specific commit, tag, or remote branch. Your repository is then in a state called Detached Head [^1]  
