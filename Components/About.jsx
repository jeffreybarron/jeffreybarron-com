...
export default function About() {
  return (
    <div className="text-primary-contrast font-bodyText sticky items-center justify-center align-middle z-50">
      <div className="z-50 bg-primary">
        <div className="md:pt-12 md:pl-12">
          <h3 className="p-2">About Me</h3>
        </div>
        <div className="md:px-24 md:pb-12 text-xl z-20">
          <p className="p-2">Hi there I&apos;m Jeff!</p>
          <p className="p-2">I&apos;m a software engineer with a passion for exploring the why and
